...
//audio clips
let audio = new Audio('assets/audio/wrasling/matchwin.mp3');
let force = new Audio('assets/audio/wrasling/cant_kick_out.mp3');
let winWin = new Audio('assets/audio/wrasling//matchwin.mp3');
let champ = new Audio('assets/audio/wrasling/gamewin.mp3');
let impact = new Audio('assets/audio/wrasling/afterhit.mp3');
let notWork = new Audio('assets/audio/wrasling/itsnotworking.mp3');
...
let characters = {
    ...
    'StoneCold': {
        ...
        health: 200,
        attack: 29,
        imageUrl: "assets/images/stone.jpg",
        enemyAttackBack: 11
    }, 
    'Mankind': {
        name: 'Mankind',
        health: 302,
        attack: 18,
        imageUrl: "assets/images/mick.jpg",
        enemyAttackBack: 41
    }, 
    'HulkHogan': {
        name: 'HulkHogan',
